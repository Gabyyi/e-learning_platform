...
function showPopup2() {
    const modal = document.getElementById('cardModal2');
    modal.style.display = 'block';
}
...
function addCard() {
    ...
    const modal = document.getElementById('cardModal');
    const selectedOption = document.getElementById('cardOption').value;
    const newCard = template.content.cloneNode(true);
  
    newCard.querySelector('.card-title').textContent = selectedOption;

    newCard.querySelector('.course').addEventListener('click', function() {
      window.location.href = 'assessments.html';
    });
  
    container.insertBefore(newCard, document.getElementById('addCard'));
