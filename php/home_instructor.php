...
<body>
    ...
    <?php 
        $database_query = "SELECT * FROM proiect_baza_de_date.instructors WHERE userID = '$_SESSION[userID]'";
        ...
        <div class="container courses_container">
            <?php if ($result->num_rows > 0): ?>
                <?php while($row = $result->fetch_assoc()): ?>
                    <a href="addlessons.php?id=<?php echo $row['pedagogyID']; ?>&ID=<?php echo $row['instructorID']; ?>">
