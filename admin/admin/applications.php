<?php
	...
	$database_query="INSERT INTO proiect_baza_de_date.users (userID,fullName,email,password,role,subscription,joinDate) VALUES ( NULL , '$_POST[fullname]' , '$_POST[email]' , '$_POST[password]' , 'Student' , 'Freeby', '$currentdate' )";
    ...
    $database_query="INSERT INTO proiect_baza_de_date.applications (applicationID, userID, fullName, email, subject, bio) VALUES ( NULL , '$_SESSION[userID]' , '$_POST[fullname]' , '$_POST[email]' , '$_POST[pedagogy]' , '$_POST[bio]' )";
    mysqli_query($database_connection, $database_query) or die("Query error to database: $databasename");
